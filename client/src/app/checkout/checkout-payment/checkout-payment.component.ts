...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe(
      'pk_test_51OXG1mJsAuMr1VLZYLteO6D2PGKN88SpE8Odbjr4nmC9Mm8AdK5fkDtCclpiFLzsnRR3pwWVNh5cqLPRcKw3WNZK00Hkwb5jbn'
    ).then((stripe) => {
      this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if (!result) throw new Error('Problem atempting payment with strip');
    return result;
  }
